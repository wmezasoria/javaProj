...
public class SimpleAudioPlayer {
	...
	public static void main(String[] args) {
		/*
		 * We check that there is exactely one command-line argument. If not, we
		...
		/*
		 * Now, that we're shure there is an argument, we take it as the
		 * filename of the soundfile we want to play.
		 */
